 ...
 * Scores are normalized via log-scaling against provided max values
...
public class ScoringService {
     ...
     * @param maxStars     the maximum stars value for normalization
     * @param maxForks     the maximum forks value for normalization
     * @return sorted list of scored repositories in descending score order
     */
    public List<ScoredRepository> scoreAndRank(List<GitHubRepository> repositories, int maxStars, int maxForks) {
