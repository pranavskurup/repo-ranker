...
class ScoringServiceTest {
    ...
    void scoreAndRankShouldReturnEmptyListForEmptyInput() {
        List<ScoredRepository> result = scoringService.scoreAndRank(List.of(), 100, 50);
    ...
    void scoreAndRankShouldReturnSingleRepo() {
        ...
        List<ScoredRepository> result = scoringService.scoreAndRank(List.of(repo), 100, 20);
    ...
    void scoreAndRankShouldRankHigherStarsHigher() {
        ...
        List<ScoredRepository> result = scoringService.scoreAndRank(List.of(lowStars, highStars), 1000, 10);
    ...
    void scoreAndRankShouldRankHigherForksHigher() {
        ...
        List<ScoredRepository> result = scoringService.scoreAndRank(List.of(lowForks, highForks), 100, 500);
    ...
    void scoreAndRankShouldRankRecentlyUpdatedHigher() {
        ...
        List<ScoredRepository> result = scoringService.scoreAndRank(List.of(oldUpdate, recentUpdate), 100, 50);
    ...
    void scoreAndRankShouldUseLogNormalization() {
        ...
        List<ScoredRepository> result = scoringService.scoreAndRank(List.of(repo1, repo2), 10000, 5);
    ...
    void scoreShouldBeBetween0And100() {
        ...
        List<ScoredRepository> result = scoringService.scoreAndRank(List.of(repo), 500, 100);
    ...
    void scoreAndRankShouldSortDescendingByScore() {
        ...
        List<ScoredRepository> result = scoringService.scoreAndRank(List.of(repo1, repo2, repo3), 500, 100);
    ...
    void scoreShouldUseCorrectWeights() {
        ...
        List<ScoredRepository> result = scoringService.scoreAndRank(List.of(starsOnly, forksOnly), 10000, 10000);
